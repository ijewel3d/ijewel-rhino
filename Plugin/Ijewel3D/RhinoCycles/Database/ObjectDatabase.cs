...
namespace RhinoCyclesCore.Database
{
	public class ObjectDatabase : IDisposable
	{
		...
		/// </summary>
		private readonly ConcurrentDictionary<Tuple<Guid, int>, CyclesMesh> _cqMeshChanges = new ConcurrentDictionary<Tuple<Guid, int>, CyclesMesh>();
		private readonly ConcurrentDictionary<IntPtr, ccl.Transform> _cqMeshOcsFrames = new ConcurrentDictionary<IntPtr, ccl.Transform>();
		/// <summary>
		/// record mesh removes from cycles
		/// </summary>
		private readonly ConcurrentQueue<Guid> _cqMeshesToDelete = new ConcurrentQueue<Guid>();
		/// <summary>
		/// record what meshid tuple corresponds to what cycles mesh
		/// </summary>
		private readonly ConcurrentDictionary<Tuple<Guid, int>, CclMesh> _rhCclMeshes = new ConcurrentDictionary<Tuple<Guid, int>, CclMesh>();
		...
		/// </summary>
		private readonly ConcurrentDictionary<Tuple<Guid, int>, bool> _rhCclMeshesSolid = new ConcurrentDictionary<Tuple<Guid, int>, bool>();
		/// <summary>
		...
		/// </summary>
		private readonly ConcurrentDictionary<uint, CclObject> _rhCclObjects = new ConcurrentDictionary<uint, CclObject>();
		/// <summary>
		/// record objects to push to cycles
		/// </summary>
		private readonly ConcurrentQueue<CyclesObject> _cqNewUpdatedObjects = new ConcurrentQueue<CyclesObject>();
		/// <summary>
		/// record objects to remove/hide in cycles
		/// </summary>
		private readonly ConcurrentQueue<CyclesObject> _cqDeletedObjects = new ConcurrentQueue<CyclesObject>();
		/// <summary>
		/// record dynamic object transformations
		/// </summary>
		private readonly ConcurrentQueue<CyclesObjectTransform> _cqObjectTransform =  new ConcurrentQueue<CyclesObjectTransform>();
		#endregion
